...
public class bastardGhostController : MonoBehaviour
{
    /*
    ...
    */
    ...
    public GameObject bastardTarget;
    ...
    */
    ...
    public static int bastardPelletCount = 30;
    private int currentCount;
    private float altX;
    private float altY;
    private bool starting = true;
    private bool oneUnDone = true;
    ...
    void Start()
    {
        ...
        currentCount = bastardPelletCount;
        speed = 0.0f;
        bastardTarget.transform.position = new Vector2(10.5f,5f);
    }
    ...
    private void intersection()
    {
        ...
        {
            targetX = bastardTarget.transform.position.x;
            targetY = bastardTarget.transform.position.y;
    ...
    private void targetManagement()
    {
        if (mode == 2)
        {
            ...
            {
                altX = PacmanController.transform.position.x - 2;
            ...
            {
                altX = PacmanController.transform.position.x - 2;
                altY = PacmanController.transform.position.y + 2;
            }
            altX = redGhost.transform.position.x - altX;
            altX = PacmanController.transform.position.x -altX;
            altY = redGhost.transform.position.y - altY;
            altY = PacmanController.transform.position.y -altY;
            bastardTarget.transform.position = new Vector2(altX,altY);
        }
        if (mode == 1)
        {
            // This vector 2 needs to be updated to roughly whatever the bottom right corner is.
            bastardTarget.transform.position = new Vector2(18.3f,-13f);
        }
    }
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.tag == "bastardTarget")
        {
            if (mode == 3 && starting == false)
            {
                ...
                {
                    bastardTarget.transform.position = new Vector2(10.5f,3.0f);
                    face = 2;
                    animator.SetInteger("face", face);
                    direction = Vector2.down;
                    targetCollision += 1;
                ...
                if (targetCollision == 1)
                {
                    ...
                    animator.SetInteger("face", face);
                    direction = Vector2.up;
                    bastardTarget.transform.position = new Vector2(10.5f,5.0f);
                    targetCollision += 1;
                }
            }
            if (starting)
    ...
    {
        if (currentCount <= 0 && oneUnDone)
        {
            bastardPelletCount = 0;
            oneUnDone = false;
            face = 1;
            direction = Vector2.left;
            animator.SetInteger("face", face);
    ...
    public void resetTime()
    {
        ...
        animator.SetInteger("face", face);
        speed = 0.0f;
        transform.position = new Vector2(10.0f,3.0f);
        direction = Vector2.right;
